...
<div class="pos-f-t">
    ...
    <br><br>
    <h1 style="text-align: center;" style="font-size: 24px; ">Sınıf Ekleyiniz</h1>
    <br>
    <div class="container">
        <div>
            <form action="sinif-islem.php" method="post">
                <div class="form-group">


                    <label>Sınıf Adı</label>
                    <input type="text" class="form-control" name="sinif_adi">
                    <br>
                    

                </div>
                <br>
                <button name="sinif-ekle" type="submit" class="btn btn-primary">Sınıf Ekle</button>
            </form>
