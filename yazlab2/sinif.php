...
<body style="background-color: #dddddd;">
    ...
    <div class="container">
        ...
        <br>
        <a href="sinif-ekle.php"><button style="float:right" class="btn btn-dark" type="submit">Sınıf
                Ekle</button></a>
        <br><br>
        <table class="table  table-hover " style="background-color: #cccccc;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="sinif-islem.php?sinifsil&sinif_id=<?php echo $uruncek["sinif_id"] ?>"><button
